...
public class WeatherApi {
	...
	@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Sample to be created", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = SampleTransfer.class)), required = true)
	@ApiResponses(value = {
